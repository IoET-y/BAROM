...
TARGET_DATASET_KEY_BENCHMARK = 'reaction_diffusion_neumann_feedback' # Example

DATASET_CONFIGS = {
    'reaction_diffusion_neumann_feedback': { # Ensure this key matches TARGET_DATASET_KEY_BENCHMARK
        ...
        'dataset_type_arg': 'reaction_diffusion_neumann_feedback' # For UniversalPDEDataset
    }
...
def main(target_model_key_main):
    ...
    BENCHMARK_T_HORIZONS_PHYSICAL = [ 1.5, 1.75, 2.0] # Example physical times
